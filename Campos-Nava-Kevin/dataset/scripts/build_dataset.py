...
Uso:
    ...
    python3 dataset/scripts/build_dataset.py --families Mirai Gafgyt --limit 200 --merge
...
# El script vive en dataset/scripts/; el catálogo (csv/json) vive en dataset/.
...
def main():
    ...
    parser.add_argument(
        ...
        help="carpeta de salida para botnet_elf.csv / .json (def: dataset/)",
    )
    parser.add_argument(

...
(function () {
  ...
  /* ---- 1. Constructor de experimentos ----
     Vive ahora en index.html con Alpine.js (componente `experimentos`): añadir/
     quitar experimentos, marcar comandos y gestionar chips de forma reactiva.
     Aquí ya no se hace nada de eso (antes se clonaba/reindexaba el DOM a mano). */
